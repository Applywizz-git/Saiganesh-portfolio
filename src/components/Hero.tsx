...
const Hero = () => {
  ...
  const fullText = "Creative Java Full Stack Developer";
  ...
  const socialLinks = [
    { icon: Github, href: 'https://github.com/siruvuri-java', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/ssgv', label: 'LinkedIn' },
  ...
  >
    <div className="bg-white text-black text-sm font-semibold px-4 py-1 rounded-md border-2 border-blue-400 shadow-md transform rotate-[-1deg]">
      nice to meet you
          ...
          >
Java Full Stack Developer with 6+ years building scalable apps using Spring Boot, React.js, and AWS.
        ...
        >
          ...
          <a href="Resume_sai_ganesh.pdf" download>
